...
extension PathAnimationHelper {
    static func create(_ p1: CGPoint, _ p2: CGPoint, usePath: Bool = true, offset: CGFloat = 40) -> PathAnimationHelper {
        var nodes: [CGPoint]
        ...
        return PathAnimationHelper(points: nodes)
    }
}
